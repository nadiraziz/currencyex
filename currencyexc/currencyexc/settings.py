"""
Django settings for currencyexc project.
...
ALLOWED_HOSTS = ['127.0.0.1', 'currency-exc.herokuapp.com']
...
WSGI_APPLICATION = 'currencyexc.wsgi.application'
